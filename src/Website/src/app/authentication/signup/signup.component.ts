...
export class MerchantSignUpComponent implements OnInit {
  ...
  signupTimeout: boolean = false;
  signupComplete: boolean = false;
  returnUrl: string = "/home";
  requireMerchantRegistration: boolean = false;
  requirePosRegistration: boolean = false;
  termsConditionsChecked: boolean = false;
  ...
  constructor(
    ...
    this.termsAndConditionsText = translate.instant(
      "TERMS_CONDITIONS.MAIN_TEXT"
    );
  }
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.formSubmit = this.fb.group({
      ...
      tcInfo: [
        { value: this.termsAndConditionsText, disabled: true },
        !Validators.required,
      ],
    });
  }
